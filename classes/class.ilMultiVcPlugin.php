...
class ilMultiVcPlugin extends ilRepositoryObjectPlugin
{
    ...
    // ILIAS 11 raises participant events under the "components/ILIAS/*" component
    // names (formerly "Modules/Course" / "Modules/Group"); the event handler
    // matches the component string exactly, without aliasing.
    public const COMPONENT_COURSE = 'components/ILIAS/Course';
    public const COMPONENT_GROUP = 'components/ILIAS/Group';
    ...
    public function handleEvent(string $a_component, string $a_event, array $a_parameter): void
    {
        ...
        switch ($a_component) {
            case self::COMPONENT_COURSE:
            case self::COMPONENT_GROUP:
